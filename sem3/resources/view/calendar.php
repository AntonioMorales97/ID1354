    ...
    <div class="calendar">
        ...
        <div class="week">
            ...
            <div class="day"><p>Thursday 4</p>
                <a href="index.php?page=Glazed%20Meatballs">
                    <img class="img-responsive" src=<?php echo Util\Util::IMG_PATH."smallmeatballs.jpg";?> alt="Go to meatball recipe">
                </a>
            </div>
        ...
        <div class="week">
            ...
            <div class="day"><p>Wednesday 17</p>
                <a href="index.php?page=Swedish%20Pancakes">
                    <img class="img-responsive" src=<?php echo Util\Util::IMG_PATH."smallpancakes.jpeg";?> alt="Go to pancake recipe">
                </a>
            </div>
