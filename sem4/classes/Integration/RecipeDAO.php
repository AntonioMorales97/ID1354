...
class RecipeDAO{
    ...
    /**
     * This function gets the recipe id for the given recipe title from the database.
     * @param $recipe_title - the recipe title.
     * @return the recipe id of the given recipe title.
     */
