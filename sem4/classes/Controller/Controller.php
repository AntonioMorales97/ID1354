...
class Controller{
    ...
    /**
     * This method gets the user id with the matching username.
     * @param $username
     * @return the user id.
     */
    ...
    /**
     * This method gets the id of the comment that was posted most recently on the recipe page of the given recipe.
     * @param $recipe_title the recipe title where the comment was posted.
     * @return the id of the last posted comment.
     */
    public function getLatestCommentID($recipe_title){
        $commentDAO = new CommentDAO();
        return $commentDAO->getLatestCommentID($recipe_title);
    }

    /**
     * Retrieves the comment with the given comment id.
